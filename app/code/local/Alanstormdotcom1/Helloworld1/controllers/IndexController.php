 ...
 */
class Alanstormdotcom1_Helloworld1_IndexController extends Mage_Core_Controller_Front_Action {        
    ...
    public function indexAction()
    {
		...
		//$this->loadLayout();
		//$block = $this->getLayout()->createBlock('Mage_Core_Block_Template','popup_form',array('template' => 'popup/form.phtml'));
